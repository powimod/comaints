...
import {
    ComaintApiError, ComaintApiErrorInvalidRequest, ComaintApiErrorUnauthorized,
    ComaintApiErrorInvalidToken, ComaintApiErrorExpiredToken
            ...
            case AUTH_OPERATION_ACCOUNT_DELETION:
                ...
                if (companyId !== null) {
                    try {
                        ...
                        console.log('Company not deleted', error);
                    }
                }
                break;
